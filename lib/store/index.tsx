...
export function RoastHubProvider({ children }: { children: React.ReactNode }) {
...
export function useRoastHub() {
  const ctx = useContext(StoreCtx);
  if (!ctx) throw new Error("useRoastHub must be used within RoastHubProvider");
  return ctx;
}
