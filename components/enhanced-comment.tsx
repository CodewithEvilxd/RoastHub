...
import { useRoastHub, type Comment } from "@/lib/store";
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="flex flex-wrap items-center justify-between gap-2 mb-2">
              ...
              {isOwner && (
                <div className="relative">
                  ...
                  {showMenu && (
                    <div className="absolute right-0 top-8 bg-white comic-border-2 rounded-lg comic-shadow-3 z-10 min-w-30">
                      <button
                        onClick={() => {
                          setIsEditing(true);
                          setShowMenu(false);
            ...
            {isEditing ? (
              ...
              <p
                className={cn(
                  body.className,
                  "text-[#2c2c2c] mb-3 wrap-break-word"
                )}
              >
                {comment.text}
              </p>
