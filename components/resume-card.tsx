  ...
  return (
    ...
    >
      <ComicCard
        ...
        fontStyle="none"
        shadow="large"
        className="grid grid-rows-[auto_1fr_auto] gap-3 sm:gap-4 comic-border sm:comic-border-4 rounded-xl sm:rounded-2xl p-4 sm:p-6 h-full min-h-62.5"
      >
        ...
        <div className="flex items-center gap-1.5 sm:gap-2 mt-auto pt-2 sm:pt-3 border-t-2 border-[#2c2c2c]/20">
          ...
          >
            ...
            <span className="rounded-full border sm:border-2 border-[#2c2c2c] bg-[#F2D5A3] px-1.5 sm:px-2 py-0.5 text-xs font-normal">
              {resume.likes}
            </span>
          </button>
