...
export function MyResumeCard({ resume, onEdit }: MyResumeCardProps) {
  const { like, deleteResume } = useRoastHub();
        ...
        <div className="flex items-start gap-3 sm:gap-4">
          ...
          <div className="min-w-0 flex-1">
            <h3
              className={cn(
                display.className,
                "text-lg sm:text-2xl lg:text-3xl font-normal tracking-wide text-[#2c2c2c] mb-1 sm:mb-2 wrap-break-word"
              )}
              style={{
        ...
        <div className="pt-3 border-t-2 border-[#2c2c2c]/20">
          ...
          <div className="flex items-center justify-between  sm:gap-2 mb-2">
            ...
            >
              ...
              <span className="rounded-full border sm:border-2 border-[#2c2c2c] bg-[#F2D5A3] px-1 sm:px-1.5 py-0.5 text-xs font-normal">
                {resume.likes}
              </span>
            </button>
