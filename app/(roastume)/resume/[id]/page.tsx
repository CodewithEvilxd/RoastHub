...
export default function ResumeDetail() {
  ...
  const { find, like, fetchResumeById, loading } = useRoastHub();
    ...
    <div className="grid gap-6">
      <div className="flex flex-wrap items-center gap-2 sm:gap-3">
        ...
        <h2
          className={cn(
            display.className,
            "ml-2 text-2xl sm:text-3xl font-extrabold tracking-wide text-[#F2D5A3] wrap-break-word"
          )}
          style={{
            textShadow: [
              "4px 4px 0 #2a7e84",
      ...
      <div className="grid gap-6 lg:grid-cols-[1fr_0.9fr] items-start">
        <ComicCard className="grid gap-3">
          <div className="rounded-lg sm:rounded-xl border-2 sm:border-[3px] border-[#2c2c2c] bg-white p-0 sm:p-2 shadow-[2px_2px_0_#2c2c2c] sm:shadow-[3px_3px_0_#2c2c2c] overflow-hidden">
  ...
  return (
    <div className="flex items-center">
      ...
      >
        ...
        {isLiked ? "Liked" : "Like"}
        <span className="ml-1 rounded-full border-2 border-[#2c2c2c] bg-white px-2 py-0.5 text-xs">
          {resume?.likes ?? likes}
        </span>
      </button>
    </div>
