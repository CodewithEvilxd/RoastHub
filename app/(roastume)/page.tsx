...
export default function Page() {
  ...
  return (
    <div className="grid gap-6">
      ...
      <PageCongratsToast />
      {session && showWelcome && (
        <ComicCard className="p-4 bg-linear-to-r from-[#F2D5A3] to-[#F8E4C6] relative">
          <button
            onClick={(e) => {
              e.preventDefault();
              e.stopPropagation();
      ...
      {resumes.length === 0 ? (
        ...
        <div className="grid gap-4">
          <h3
            className={cn(
              display.className,
              "text-lg sm:text-2xl lg:text-3xl font-normal tracking-wide text-[#F2D5A3] mb-1 sm:mb-2 wrap-break-word"
            )}
            style={{
              textShadow: [
                "4px 4px 0 #2a7e84",
